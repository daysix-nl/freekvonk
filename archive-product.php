                  ...
                  <?php
                    ...
                    if ( $product_labels && ! is_wp_error( $product_labels ) ) {
                        ...
                        foreach ( $product_labels as $product_label ) {
                            ...
                            $image_alt = isset($image['alt']) ? esc_attr($image['alt']) : '';
                            if ($image_url) {
                                echo '<li class="w-[25px] h-[25px] md:w-[35px] md:h-[35px] lg:w-[45px] lg:h-[45px] bg-[#8CC63F] rounded-full flex items-center justify-center overflow-hidden"><img src="' . $image_url . '" alt="' . $image_alt . '" class="min-h-full min-w-full object-cover"></li>';
                            }
                        }
                        echo '</ul>';
                    }
