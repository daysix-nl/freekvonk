                ...
                if( have_rows('slider') ):
                    ...
                    <div class="swiper-slide">
                        <div class="grid grid-cols-1 lg:grid-cols-2">
                            ...
                            <div class="lg:aspect-square h-[460px] w-full lg:h-[46vw] lg:w-[50vw] lg:flex lg:items-center lg:justify-center <?php the_sub_field('achtergrond');?> overflow-hidden">
                                <div class="max-w-[390px] px-2 md:px-[unset] md:max-w-[603px] mx-auto lg:w-[506px] h-[385x] lg:max-h-[500px] z-[40] py-[60px] lg:py-[unset] overflow-hidden">
