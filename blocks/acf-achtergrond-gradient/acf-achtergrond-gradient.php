...
if (isset($block['data']['preview_image_help'])): ?>
    <img src="https://freekvonk.attentionseekers.studio/wp-content/themes/freekvonk/img/preview/gradient.png" style="width:100%; height:auto;">
    <?php
else: ?>
<?php
...
<section id="<?php the_field('section_id');?>" class="bg-gradient-to-b <?php the_field('from');?> <?php the_field('to');?> relative overflow-hidden">
