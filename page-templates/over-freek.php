...
<main class="pt-[150px]">
    ...
    <section class="bg-[#0A1F16] relative">
        ...
        <img src="/wp-content/themes/freekvonk/img/local/patroon-2.png" alt="" class="z-[30] h-full w-full object-cover object-center absolute top-0">
    </section>
    ...
    <section>
        <div class="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div class="lg:aspect-square bg-white h-full w-full lg:h-[50vw] lg:w-[50vw] lg:flex lg:items-center lg:justify-center relative order-2 lg:order-1">
                ...
                <img src="/wp-content/themes/freekvonk/img/local/patroon-3.png" alt="" class="z-[30] h-full w-full object-cover object-center absolute top-0">
            </div>
            <!-- AFBEELDING -->
            <div class="lg:aspect-square h-[390px] md:h-[450px] lg:h-[50vw] lg:w-[50vw] overflow-hidden order-1 lg:order-2">
                <img src="http://freek-vonk.local/wp-content/themes/freekvonk/img/local/Freek-gier.png" alt="" class="h-full w-full object-cover object-center">
            </div>
        </div>
    </section>
    ...
    <section class="bg-[#523524] relative">
        ...
        <div class="container grid grid-cols-3 gap-[11px] pb-[80px] relative z-[40]">
            <img src="http://freek-vonk.local/wp-content/themes/freekvonk/img/local/Freek-gier.png" alt="" class="aspect-square lg:aspect-[4/3] overflow-hidden object-cover object-center">
            <img src="http://freek-vonk.local/wp-content/themes/freekvonk/img/local/Freek-gier.png" alt="" class="aspect-square lg:aspect-[4/3] object-cover object-center">
            <img src="http://freek-vonk.local/wp-content/themes/freekvonk/img/local/Freek-gier.png" alt="" class="aspect-square lg:aspect-[4/3] object-cover object-center">
        </div>
