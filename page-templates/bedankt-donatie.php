 ...
 <main class="freek-checkout ">
    ...
    <div class="w-full bg-[#FFFFFF] pb-[50px] xl:pb-[80px] freek-bedankt relative">
        <div class="container mt-[45px] relative z-[40]">
            <h1 class="w-full text-center font-tanker text-black text-40 leading-37 md:text-70 md:leading-58 lg:text-80 lg:leading-67 max-w-[600px] lg:max-w-[unset] mb-[15px]">Bedankt voor je donatie!</h1>
            ...
            <div class="w-full md:w-[360px] lg:w-[380px] xl:w-[450px] mx-auto text-center text-16 leading-32 font-karsen font-normal text-editor">Dankzij jouw bijdrage kunnen we wereldwijd projecten steunen van dappere mensen die zich inzetten tegen wildlife crime.</div>
        </div>
