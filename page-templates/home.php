...
<main class="pt-[33px]">
    <section class="h-[calc(100vh-33px)] flex items-center bg-[#0A1F161A]">
        <div class="grid grid-cols-1 lg:grid-cols-3 h-[calc(70vh-33px)] md:h-[calc(100vh-200px)] lg:h-[calc(100vh-33px)] w-full">
